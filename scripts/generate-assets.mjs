#!/usr/bin/env node
/**
 * Generates every brand asset for Ringaway from one source of truth: the mark below.
 *
 ...
 */
const SHAPES = [{"type":"poly","points":[[0.5,0.08],[0.63,0.14],[0.71,0.26],[0.73,0.46],[0.78,0.63],[0.84,0.71],[0.16,0.71],[0.22,0.63],[0.27,0.46],[0.29,0.26],[0.37,0.14]],"fill":"accent"},{"type":"circle","cx":0.5,"cy":0.08,"r":0.075,"fill":"accent"},{"type":"poly","points":[[0.4,0.78],[0.6,0.78],[0.56,0.9],[0.44,0.9]],"fill":"accentLight"}];
 ...
 */
const MARK = [[1,1,0.12,0.12,0.12],[1,1,0.12,0.12,0.12],[0.12,1,1,0.45,0.12],[0.12,0.12,1,1,1],[0.12,0.12,0.12,1,1]];
...
console.log('Generating Ringaway brand assets\n');
