...
`apps.json`). Fix it there and re-run `node scripts/bootstrap.mjs ringaway`,
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.ringaway` |
| Scheme | `ringaway://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.ringaway.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/ringaway` |
